...
namespace tacacs {
namespace libtac{
extern int libtac_log __P((int, const char*, ...));
}}}}}}

#if defined(TACSYSLOG)
#undef TACSYSLOG
#define TACSYSLOG(x) (void)::a::sys::aaa::manager::tacacs::libtac::libtac_log x;
#endif
#if defined(TACDEBUG)
#undef TACDEBUG
#define TACDEBUG(x) (void)::a::sys::aaa::manager::tacacs::libtac::libtac_log x;
#endif
